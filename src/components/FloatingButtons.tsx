...
const FloatingButtons = () => {
  const whatsappUrl = "https://api.whatsapp.com/send/?phone=51982268533&text&type=phone_number&app_absent=0";
  const linkedinUrl = "https://www.linkedin.com/company/integral-solutions-for-industrial-processes/posts/?feedView=all"
  return (
